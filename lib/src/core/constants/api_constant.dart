class Endpoints {
  ...
  static const String baseUrl = "https://real-estate-sieg.up.railway.app";
...
//_________________________________________AUTH_____________________________________________
  ...
  static const String changePassword = '/api/v1/auth/change/new-password';
  ...
  static const String createUserAcct = '/api/v1/auth/create-account';
  static const String sendEmailVerifyOtp =
      '/api/v1/auth/resend/email/verify/code/resend';

  static const String sendForgetOtp =
      "/api/v1/auth/request/forgot-password/code";
  static const String verifyEmailOTP = '/api/v1/auth/verify/email';
